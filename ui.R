...
shinyUI(pageWithSidebar(
  ...
  mainPanel(tabsetPanel(id="tabs",
                        ...
                        tabPanel("Acerca de esta APP",
                                 ...
                                 tags$hr(),
                                 HTML('<div style="clear: left;"><img src="https://raw.githubusercontent.com/guzmanlopez/Modis/master/Figuras/foto_perfil.jpg" alt="" style="float: left; margin-right:5px" /></div>'),
                                 strong('Autor'),
